      ...
      <main className="min-h-screen pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
            Born from the rugged requirements of industrial warehouses, AnvilOS
            was engineered to bridge the gap between legacy hardware retail and
          ...
          <div className="bg-surface-container border border-border p-8 rounded-sm text-left">
            ...
            <p className="text-muted-foreground">
              {" "}
              To empower independent hardware businesses with enterprise-grade
              tools that are as durable and reliable as the tools they sell.
            </p>
          </div>
        </div>
      </main>
