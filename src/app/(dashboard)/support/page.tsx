...
const faqs = [
  { q: "How do I add a new product?", a: "Navigate to Inventory, click Add Product, fill in the details, and save." },
  { q: "How do I process a return?", a: "Open the POS terminal, click the Returns tab, scan or search for the item, and complete the return." },
  { q: "How do I generate a sales report?", a: "Go to Finance, select the date range, and click Export to download CSV, XLSX, or PDF." },
  { q: "How do I manage user accounts?", a: "Go to Settings to update your profile, notification preferences, and password." },
];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-[#64748b] mt-1">Get help with CWL Hardware</p>
      </div>
      ...
      <div className="bg-white border border-[#e2e8f0] rounded-xl p-6">
        <h2 className="text-lg font-semibold text-[#0e212c] flex items-center gap-2">
          <HelpCircle className="h-5 w-5 text-[#fd761a]" /> Frequently Asked Questions
        </h2>
        <div className="mt-4 space-y-3">
          {faqs.map((faq) => (
            <details key={faq.q} className="group border border-[#e2e8f0] rounded-lg">
      ...
      <div className="bg-[#0e212c] rounded-xl p-6 text-center">
        ...
        <p className="text-[#94a3b8] text-xs mt-1">Our support team is available Monday to Saturday, 8:00 AM to 6:00 PM</p>
        <a href="mailto:support@cwlhardware.com"
