...
const features = [
  {
    ...
    description: "Track stock across aisles with automated low-stock alerts and cycle count workflows.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Process transactions, handle returns, and log damages in seconds with a focused interface.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Security-first tracking for every action. Know exactly who adjusted stock and when.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10m10 0a1 1 0 01-1 1H5a1 1 0 01-1-1m10 0h4a1 1 0 001-1V9a1 1 0 00-1-1h-4m-3 4h.01M9 13h.01" />
      </svg>
    ),
    title: "Supplier Sync",
    description: "Manage vendor relationships, generate POs, and receive shipment flows seamlessly.",
  },
];
    ...
    <section className="py-24 bg-background" id="features">
      <div className="max-w-7xl mx-auto px-6">
        <RevealUp className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black text-primary mb-4 tracking-tight">Engineered for the Warehouse Floor</h2>
          <p className="text-muted-foreground text-lg">Core modules built to handle high-density data, rapid transactions, and unyielding accuracy.</p>
        </RevealUp>
