              ...
              >
                ...
                <ul className="space-y-3 flex-grow mb-8">
                  {plan.features.map((f) => (
                    ...
                    >
                      <svg
                        className={`w-5 h-5 flex-shrink-0 ${plan.featured ? "text-accent" : "text-accent"}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <button
                  className={`w-full py-3 text-xs font-bold uppercase tracking-widest rounded-sm transition-all duration-200 active:scale-95 ${
                    plan.featured
