      ...
      <main className="min-h-screen pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-12">
            Tailored hardware management stacks for industrial distributors and
            ...
            {[
              {
                ...
                desc: "Unified inventory and financial reporting across all branches.",
              },
              {
                title: "Custom API Integration",
                desc: "Connect your existing ERP or accounting software to the AnvilOS core.",
              },
            ].map((item) => (
              <div
                key={item.title}
