        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <RevealUp>
            <h1 className="text-5xl md:text-6xl font-black text-white mb-6 tracking-tight">
              Built for the{" "}
              <span className="text-safety-orange">Hardware Industry</span>
            </h1>
            <p className="text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
              CWL Hardware was born from the belief that hardware stores deserve
              software as robust as the tools they sell.
            </p>
          </RevealUp>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <RevealUp className="flex-1">
              <h2 className="text-3xl md:text-4xl font-black text-primary mb-6 tracking-tight">
                Our Mission
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                To provide industrial-grade, cloud-enabled management tools that
                empower hardware businesses of all sizes to operate with
            ...
            <RevealUp delay={150} className="flex-1">
              <div className="aspect-square rounded-xl bg-[#0a151b] border border-white/5 overflow-hidden relative shadow-2xl">
                ...
                <div className="relative z-10 flex items-center justify-center h-full">
                  <span className="text-white/10 font-black text-7xl tracking-tighter italic">
                    ANVIL
                  </span>
                </div>
              </div>
            ...
            {[
              ...
              <RevealUp key={s.label} delay={i * 100}>
                <div className="bg-card border border-border rounded-xl p-8 text-center hover:shadow-md transition-shadow">
                  <div className="text-4xl font-black text-safety-orange mb-2">
                    {s.value}
                  </div>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <RevealUp>
            ...
            <p className="text-muted-foreground mb-8">
              We are always looking for talented people who want to build the
