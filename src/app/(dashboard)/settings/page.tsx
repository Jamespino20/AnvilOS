                ...
                {[
                  ...
                  <div key={f.label}>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 border border-[#e2e8f0] rounded-lg text-sm text-[#0e212c] bg-[#f8fafc] focus:outline-none focus:border-[#fd761a] focus:ring-2 focus:ring-[#fd761a]/10 transition-all"
                    />
                  </div>
                ))}
              </div>
