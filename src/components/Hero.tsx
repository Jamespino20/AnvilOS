    ...
    <section className="relative h-screen w-full overflow-hidden bg-industrial-blue">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <h1 className="max-w-4xl text-4xl font-extrabold tracking-tighter text-white md:text-7xl lg:text-8xl">
          ...
          <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <button
              className="h-14 px-8 bg-safety-orange text-white font-bold rounded-sm hover:bg-orange-600 transition-colors active:scale-95 shadow-lg shadow-safety-orange/20 hover:shadow-xl hover:shadow-safety-orange/30"
