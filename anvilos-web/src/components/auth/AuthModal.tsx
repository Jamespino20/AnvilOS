...
export function AuthModal({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent showCloseButton={false} className="max-w-[440px] p-0 shadow-2xl border border-white/10 overflow-hidden rounded-sm bg-background industrial-grain animate-snappy">
